...
###<b>Title:County-level, weighted average arsenic concentrations (µg/L) in community water systems, 2006-2011</b><br>
```{r plot, echo=FALSE}
library(Hmisc)
library(reshape)
library(ggplot2)
